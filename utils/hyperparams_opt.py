...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    clip_range = trial.suggest_categorical("clip_range", [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.5, 0.6, 0.7, 0.9])
    n_epochs = trial.suggest_categorical("n_epochs", [1, 3, 5, 10, 15, 20])
